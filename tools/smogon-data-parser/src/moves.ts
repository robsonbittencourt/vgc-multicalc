export const Moves = {
  ...
  courtchange: {
    ...
    onHitField(target, source) {
      ...
      if (this.gameType === "freeforall") {
        ...
        const temp: Record<number, typeof source.side.sideConditions> = { 0: {}, 1: {}, 2: {}, 3: {} }
  ...
  minimize: {
    ...
    condition: {
      ...
      onRestart: () => null,
      onSourceModifyDamage(damage, source, target, move) {
        const boostedMoves = ["stomp", "steamroller", "bodyslam", "flyingpress", "dragonrush", "heatcrash", "heavyslam", "maliciousmoonsault", "supercellslam"]
