...
describe('Test calcs with stats modifiers in attacker', () => {
  it('Validate the damage Miraidon +1 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+1')
  ...
  it('Validate the damage Miraidon +2 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+2')
  ...
  it('Validate the damage Miraidon +3 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+3')
  ...
  it('Validate the damage Miraidon +4 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+4')
  ...
  it('Validate the damage Miraidon +5 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+5')
  ...
  it('Validate the damage Miraidon +6 spa', () => {
    ...
    mainPage.selectPokemonFromTeam("Miraidon").selectStatsModifier('spa', '+6')
  ...
  it('Validate the damage Koraidon +1 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+1')
  ...
  it('Validate the damage Koraidon +2 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+2')
  ...
  it('Validate the damage Koraidon +3 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+3')
  ...
  it('Validate the damage Koraidon +4 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+4')
  ...
  it('Validate the damage Koraidon +5 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+5')
  ...
  it('Validate the damage Koraidon +6 atk', () => {
    ...
    mainPage.selectPokemonFromTeam("Koraidon").selectAttackThree().selectStatsModifier('atk', '+6')
