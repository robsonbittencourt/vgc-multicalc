...
describe('Test calcs with stats modifiers in attacker', () => {
  ...
  it('Validate the damage Koraidon +1 atk', () => {
    team.selectPokemon("Koraidon").selectAttackThree().selectStatsModifier('atk', '+1')
  ...
  it('Validate the damage Koraidon +2 atk', () => {
    team.selectPokemon("Koraidon").selectAttackThree().selectStatsModifier('atk', '+2')
  ...
  it('Validate the damage Koraidon +3 atk', () => {
    team.selectPokemon("Koraidon").selectAttackThree().selectStatsModifier('atk', '+3')
  ...
  it('Validate the damage Koraidon +4 atk', () => {
    team.selectPokemon("Koraidon").selectAttackThree().selectStatsModifier('atk', '+4')
  ...
  it('Validate the damage Koraidon +5 atk', () => {
    team.selectPokemon("Koraidon").selectAttackThree().selectStatsModifier('atk', '+5')
