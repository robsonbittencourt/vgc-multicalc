import { applyEarlyReturnGuards, applyTypeGuards, applyFixedDamageGuards, computeMoveType, computeTypeEffectiveness, CombatContext } from "@lib/calc/engine/guards"
