...
describe("Status", () => {
  it("should initialize with the correct code and description", () => {
    ...
    expect(Status.BADLY_POISON.code).toBe("tox")
    expect(Status.BADLY_POISON.description).toBe("Badly Poison")
  ...
  it("should find status by code", () => {
    ...
    expect(Status.byCode("tox")).toBe(Status.BADLY_POISON)
  ...
  it("should find status by description", () => {
    ...
    expect(Status.byDescription("Badly Poison")).toBe(Status.BADLY_POISON)
  ...
  it("should return all descriptions", () => {
    ...
    expect(descriptions).toContain("Badly Poison")
