...
import { ACTUAL, BOOSTER, MAX, MAX_BASE_SPEED_FOR_TR, MIN, OPPONENT, SPEED_TIE, YOUR_TEAM } from "@multicalc/constants"
...
import { SpeedDefinition } from "@multicalc/speed-calculator/speed-definition"
...
export class SpeedCalculatorService {
  ...
  orderedPokemon(pokemon: Pokemon, field: Field, pokemonEachSide: number, teamPokemon: SpeedTeamPokemon, options: SpeedCalculatorOptions = new SpeedCalculatorOptions(), opponentsNoPaddingThreshold = 0): SpeedDefinition[] {
  ...
  private loadSpeedMeta(teamPokemon: SpeedTeamPokemon, options: SpeedCalculatorOptions, field: Field): SpeedDefinition[] {
  ...
  private loadMyTeam(myTeam: Pokemon[], options: SpeedCalculatorOptions, field: Field): SpeedDefinition[] {
