...
describe("Damage — ally-provided field boosts", () => {
  it("Helping Hand: boosts the attacker's damage by 1.5x", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Iron Hands Helping Hand Close Combat vs. 32 HP / 1 Def Amoonguss: 117-138 (52.9 - 62.4%) -- guaranteed 2HKO")
  })
  ...
  it("Battery: boosts an ally's special attack by 1.3x", () => {
    ...
    expect(result.description()).toEqual("32+ SpA Iron Hands Battery boosted Thunderbolt vs. 32 HP / 1 SpD Amoonguss: 37-44 (16.7 - 19.9%) -- guaranteed 6HKO")
  })
  ...
  it("Power Spot: boosts an ally's damage by 1.3x", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Iron Hands Power Spot boosted Close Combat vs. 32 HP / 1 Def Amoonguss: 102-120 (46.1 - 54.2%) -- 56.6% chance to 2HKO")
  })
  ...
  it("Friend Guard: reduces incoming damage to 0.75x", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Iron Hands Close Combat vs. 32 HP / 1 Def Amoonguss with an ally's Friend Guard: 58-70 (26.2 - 31.6%) -- guaranteed 4HKO")
  })
})
