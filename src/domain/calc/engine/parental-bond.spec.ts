...
describe("Parental Bond — child hit and berry consumption", () => {
  ...
  it("should consume a resist berry on a super-effective first hit and not reduce the child hit again", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Parental Bond Kangaskhan-Mega Fire Punch vs. 0 HP / 0 Def Ferrothorn: 110-132 (73.8 - 88.5%) reduced by Occa Berry -- guaranteed 2HKO")
  ...
  it("should consume a resist berry on a Normal-type move even when the hit is not super-effective", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Parental Bond Kangaskhan-Mega Facade vs. 0 HP / 0 Def Ferrothorn: 18-22 (12 - 14.7%) reduced by Chilan Berry -- possible 7HKO")
  })
  ...
  it("should not consume the resist berry on either hit when an ally on the field has Unnerve (e.g. Aerodactyl alongside Kangaskhan-Mega)", () => {
    ...
    expect(result.description()).toEqual("32+ Atk Parental Bond Kangaskhan-Mega Fire Punch vs. 0 HP / 0 Def Ferrothorn: 184-220 (123.4 - 147.6%) -- guaranteed OHKO")
