...
describe("Damage Calc Service (new)", () => {
  describe("Base damage", () => {
    it("physical STAB move", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Darkest Lariat vs. 0 HP / 0 Def Arcanine: 88-105 (53.3 - 63.6%) -- guaranteed 2HKO")
      expect(result.damage).toEqual([88, 90, 90, 91, 93, 94, 94, 96, 97, 97, 99, 100, 100, 102, 103, 105])
    })

    it("special STAB move", () => {
      const attacker = new Pokemon("Gardevoir", { sps: { spa: 25 }, nature: "Modest" })
      ...
      expect(result.description()).toEqual("25+ SpA Gardevoir Moonblast vs. 32 HP / 1 SpD Tyranitar: 168-198 (81.1 - 95.6%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(168)
      expect((result.damage as number[])[15]).toEqual(198)
    })

    it("super-effective move (2x)", () => {
      const attacker = new Pokemon("Chandelure", { sps: { spa: 22 }, nature: "Modest" })
      const defender = new Pokemon("Avalugg", { sps: { hp: 32, def: 32 }, nature: "Bold" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("22+ SpA Chandelure Flamethrower vs. 32 HP / 0 SpD Avalugg: 318-374 (157.4 - 185.1%) -- guaranteed OHKO")
      expect((result.damage as number[])[0]).toEqual(318)
      expect((result.damage as number[])[15]).toEqual(374)
    })

    it("not very effective move (0.5x)", () => {
      const attacker = new Pokemon("Volcarona", { sps: { spa: 16 }, nature: "Modest" })
      const defender = new Pokemon("Arcanine", { sps: { hp: 31, spd: 2 } })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("16+ SpA Volcarona Flamethrower vs. 31 HP / 2 SpD Arcanine: 46-55 (23.4 - 28%) -- 90.1% chance to 4HKO")
    ...
    it("spread damage reduction (0.75x) in Doubles", () => {
      const attacker = new Pokemon("Manectric", { sps: { spa: 32 }, nature: "Timid" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, spd: 13 } })
      const move = new Move("Discharge")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32 SpA Manectric Discharge vs. 32 HP / 13 SpD Incineroar: 42-51 (20.7 - 25.2%) -- 0.1% chance to 4HKO")
  ...
  describe("Base Power — variable move formulas", () => {
    it("Payback: doubles BP when the target already moved", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Hydreigon Payback (100 BP) vs. 0 HP / 0 Def Gardevoir: 115-136 (80.4 - 95.1%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(115)
      expect((result.damage as number[])[15]).toEqual(136)
    })

    it("Electro Ball: r>=4 → BP 150", () => {
      const attacker = new Pokemon("Ampharos", { sps: { spa: 32, spe: 32 }, nature: "Timid" })
      ...
      expect(result.description()).toEqual("32 SpA Ampharos Electro Ball (60 BP) vs. 0 HP / 0 SpD Incineroar: 52-63 (30.5 - 37%) -- 66.9% chance to 3HKO")
    ...
    it("Gyro Ball: slow attacker vs fast defender → high BP", () => {
      const attacker = new Pokemon("Avalugg", { sps: { atk: 32 } })
      const defender = new Pokemon("Arcanine", { sps: { spe: 32 }, nature: "Timid" })
      const move = new Move("Gyro Ball")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32 Atk Avalugg Gyro Ball (84 BP) vs. 0 HP / 0 Def Arcanine: 27-32 (16.3 - 19.3%) -- possible 6HKO")
    ...
    it("Low Kick: heavy target (>=200 kg) → BP 120", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Low Kick (120 BP) vs. 0 HP / 0 Def Snorlax: 194-230 (82.5 - 97.8%) -- guaranteed 2HKO")
    ...
    it("Grass Knot: heavy target → BP 120", () => {
      const attacker = new Pokemon("Gardevoir", { sps: { spa: 32 }, nature: "Timid" })
      const defender = new Pokemon("Snorlax", {})
      ...
      expect(result.description()).toEqual("32 SpA Gardevoir Grass Knot (120 BP) vs. 0 HP / 0 SpD Snorlax: 62-73 (26.3 - 31%) -- guaranteed 4HKO")
    ...
    it("Hex: doubles BP when defender has status", () => {
      const attacker = new Pokemon("Sableye", { sps: { spa: 32 }, nature: "Modest" })
      ...
      expect(result.description()).toEqual("32+ SpA Sableye Hex (130 BP) vs. 0 HP / 0 SpD Arcanine: 94-112 (56.9 - 67.8%) -- guaranteed 2HKO after burn damage")
    ...
    it("Heavy Slam: large weight ratio → BP 120", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Snorlax Heavy Slam (120 BP) vs. 0 HP / 0 Def Gardevoir: 190-224 (132.8 - 156.6%) -- guaranteed OHKO")
    ...
    it("Stored Power: BP scales with positive boosts", () => {
      const attacker = new Pokemon("Gardevoir", { sps: { spa: 32 }, nature: "Timid", boosts: { spa: 4, spe: 2 } })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("+4 32 SpA Gardevoir Stored Power (140 BP) vs. 0 HP / 0 SpD Arcanine: 418-493 (253.3 - 298.7%) -- guaranteed OHKO")
    ...
    it("Acrobatics: doubles BP without item", () => {
      const attacker = new Pokemon("Hawlucha", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Hawlucha Acrobatics (110 BP) vs. 0 HP / 0 Def Incineroar: 90-106 (52.9 - 62.3%) -- guaranteed 2HKO")
    ...
    it("Acrobatics: doubles BP with Booster Energy consumed when Protosynthesis is active", () => {
      const attacker = new Pokemon("Roaring Moon", { sps: { atk: 32 }, nature: "Adamant", ability: "Protosynthesis", item: "Booster Energy", abilityOn: true, boostedStat: "atk" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, def: 32 }, nature: "Impish" })
      const move = new Move("Acrobatics")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ Atk Protosynthesis Roaring Moon Acrobatics (110 BP) vs. 32 HP / 32+ Def Incineroar: 73-86 (36.1 - 42.5%) -- guaranteed 3HKO")
    ...
    it("Weather Ball: doubles BP in weather, changes type", () => {
      const attacker = new Pokemon("Charizard-Mega-Y", { sps: { spa: 0 } })
      const defender = new Pokemon("Gardevoir", {})
    ...
    it("Nature Power: becomes Tri Attack without terrain", () => {
      const attacker = new Pokemon("Tangrowth", { sps: { spa: 32 }, nature: "Modest", ability: "Regenerator" })
      const defender = new Pokemon("Blissey", { sps: { hp: 32 }, nature: "Bold", ability: "Natural Cure" })
      const move = new Move("Nature Power")
      const field = new Field({ gameType: "Singles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Tangrowth Nature Power (80 BP Normal) vs. 32 HP / 0 SpD Blissey: 35-42 (9.6 - 11.6%) -- possible 9HKO")
    ...
    it("Nature Power: becomes Thunderbolt in Electric Terrain", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Tangrowth Nature Power (90 BP Electric) vs. 32 HP / 0 SpD Blissey in Electric Terrain: 51-61 (14 - 16.8%) -- possible 6HKO")
    ...
    it("Nature Power: becomes Energy Ball in Grassy Terrain", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Tangrowth Nature Power (90 BP Grass) vs. 32 HP / 0 SpD Blissey in Grassy Terrain: 76-91 (20.9 - 25.1%) -- possible 5HKO after Grassy Terrain recovery")
    ...
    it("Nature Power: becomes Moonblast in Misty Terrain", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Tangrowth Nature Power (95 BP Fairy) vs. 32 HP / 0 SpD Blissey: 42-50 (11.6 - 13.8%) -- possible 8HKO")
    ...
    it("Nature Power: becomes Psychic in Psychic Terrain", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Tangrowth Nature Power (90 BP Psychic) vs. 32 HP / 0 SpD Blissey in Psychic Terrain: 51-61 (14 - 16.8%) -- possible 6HKO")
      expect(result.damage).toEqual([51, 52, 53, 53, 54, 54, 55, 56, 56, 57, 57, 58, 59, 59, 60, 61])
    })

    it("Terrain Pulse: doubles BP when grounded in terrain", () => {
      const attacker = new Pokemon("Kangaskhan", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ SpA Kangaskhan Terrain Pulse (100 BP Electric) vs. 0 HP / 0 SpD Incineroar in Electric Terrain: 45-54 (26.4 - 31.7%) -- guaranteed 4HKO")
    ...
    it("Rising Voltage: doubles BP vs grounded target in Electric Terrain", () => {
      const attacker = new Pokemon("Ampharos", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ SpA Ampharos Rising Voltage (140 BP) vs. 0 HP / 0 SpD Incineroar in Electric Terrain: 171-202 (100.5 - 118.8%) -- guaranteed OHKO")
      expect((result.damage as number[])[0]).toEqual(171)
      expect((result.damage as number[])[15]).toEqual(202)
    })

    it("Eruption: BP at full HP = 150", () => {
      const attacker = new Pokemon("Typhlosion", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Gardevoir", {})
      ...
      expect(result.description()).toEqual("32+ SpA Typhlosion Eruption (150 BP) vs. 0 HP / 0 SpD Gardevoir: 84-99 (58.7 - 69.2%) -- guaranteed 2HKO")
    ...
    it("Flail: near faint (p<=1) → BP 200", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Arcanine Reversal (200 BP) vs. 0 HP / 0 Def Gardevoir: 39-46 (27.2 - 32.1%) -- guaranteed 4HKO")
    })
    ...
    it("Hard Press: full HP target → BP near 100", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Metagross Hard Press (100 BP) vs. 0 HP / 0 Def Arcanine: 58-69 (35.1 - 41.8%) -- guaranteed 3HKO")
      expect((result.damage as number[])[0]).toEqual(58)
      expect((result.damage as number[])[15]).toEqual(69)
    })

    it("Fling: with Leftovers → BP 10", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant", item: "Leftovers" })
      const defender = new Pokemon("Gardevoir", {})
      ...
      expect(result.description()).toEqual("32+ Atk Leftovers Incineroar Fling (10 BP) vs. 0 HP / 0 Def Gardevoir: 13-16 (9 - 11.1%) -- possible 9HKO")
      expect(result.damage).toEqual([13, 13, 13, 13, 13, 13, 15, 15, 15, 15, 15, 15, 15, 15, 15, 16])
    })

    it("Fling: with Iron Ball → BP 130", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant", item: "Iron Ball" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Fling")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ Atk Iron Ball Incineroar Fling (130 BP) vs. 0 HP / 0 Def Gardevoir: 159-187 (111.1 - 130.7%) -- guaranteed OHKO")
  ...
  describe("Attacker abilities", () => {
    it("Technician: boosts moves with BP<=60 by 1.5x", () => {
      const attacker = new Pokemon("Scizor", { sps: { atk: 32 }, nature: "Adamant", ability: "Technician" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ Atk Technician Scizor Bullet Punch vs. 0 HP / 0 Def Arcanine: 33-40 (20 - 24.2%) -- guaranteed 5HKO")
    ...
    it("Technician: does not boost Solar Beam weakened to 60 BP by rain", () => {
      const attacker = new Pokemon("Venusaur", { sps: { spa: 32 }, nature: "Modest", ability: "Technician" })
      const defender = new Pokemon("Amoonguss", { sps: { hp: 32 }, nature: "Bold" })
      const move = new Move("Solar Beam")
      const field = new Field({ gameType: "Doubles", weather: "Rain" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Venusaur Solar Beam (60 BP) vs. 32 HP / 0 SpD Amoonguss in Rain: 14-17 (6.3 - 7.6%)")
      expect(result.damage).toEqual([14, 14, 15, 15, 15, 15, 15, 15, 15, 16, 16, 16, 16, 16, 16, 17])
    })

    it("Strong Jaw: boosts biting moves by 1.5x", () => {
      const attacker = new Pokemon("Sharpedo-Mega", { sps: { atk: 32 }, nature: "Adamant", ability: "Strong Jaw" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ Atk Strong Jaw Sharpedo-Mega Bite vs. 0 HP / 0 Def Arcanine: 108-127 (65.4 - 76.9%) -- guaranteed 2HKO")
    ...
    it("Sharpness: boosts slicing moves by 1.5x", () => {
      const attacker = new Pokemon("Gallade", { sps: { atk: 32 }, nature: "Adamant", ability: "Sharpness" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ Atk Sharpness Gallade Sacred Sword vs. 0 HP / 0 Def Arcanine: 148-175 (89.6 - 106%) -- 37.5% chance to OHKO")
    ...
    it("Mega Launcher: boosts pulse moves by 1.5x", () => {
      const attacker = new Pokemon("Clawitzer", { sps: { spa: 32 }, nature: "Modest", ability: "Mega Launcher" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ SpA Mega Launcher Clawitzer Water Pulse vs. 0 HP / 0 SpD Incineroar: 176-210 (103.5 - 123.5%) -- guaranteed OHKO")
    ...
    it("Tough Claws: boosts contact moves by 1.3x", () => {
      const attacker = new Pokemon("Charizard-Mega-X", { sps: { atk: 32 }, nature: "Adamant", ability: "Tough Claws" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Tough Claws Charizard-Mega-X Dragon Claw vs. 0 HP / 0 Def Incineroar: 108-127 (63.5 - 74.7%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(108)
      expect((result.damage as number[])[15]).toEqual(127)
    })

    it("Iron Fist: boosts punching moves by 1.2x", () => {
      const attacker = new Pokemon("Infernape", { sps: { atk: 32 }, nature: "Adamant", ability: "Iron Fist" })
      const defender = new Pokemon("Gardevoir", {})
      ...
      expect(result.description()).toEqual("32+ Atk Iron Fist Infernape Fire Punch vs. 0 HP / 0 Def Gardevoir: 102-121 (71.3 - 84.6%) -- guaranteed 2HKO")
    ...
    it("Sheer Force: boosts moves with secondary effects by 1.3x", () => {
      const attacker = new Pokemon("Mawile", { sps: { atk: 32 }, nature: "Adamant", ability: "Sheer Force" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ Atk Sheer Force Mawile Iron Head vs. 0 HP / 0 Def Arcanine: 44-52 (26.6 - 31.5%) -- guaranteed 4HKO")
    ...
    it("Reckless: boosts recoil moves by 1.2x", () => {
      const attacker = new Pokemon("Staraptor", { sps: { atk: 32 }, nature: "Adamant", ability: "Reckless" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Reckless Staraptor Brave Bird vs. 0 HP / 0 Def Incineroar: 139-165 (81.7 - 97%) -- guaranteed 2HKO")
    ...
    it("Sand Force: boosts Rock/Ground/Steel in Sand by 1.3x", () => {
      const attacker = new Pokemon("Excadrill", { sps: { atk: 32 }, nature: "Adamant", ability: "Sand Force" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Iron Head")
      ...
      expect(result.description()).toEqual("32+ Atk Sand Force Excadrill Iron Head vs. 0 HP / 0 Def Gardevoir: 284-336 (198.6 - 234.9%) -- guaranteed OHKO")
      expect((result.damage as number[])[0]).toEqual(284)
      expect((result.damage as number[])[15]).toEqual(336)
    })

    it("Adaptability: STAB becomes 2x", () => {
      const attacker = new Pokemon("Dragalge", { sps: { spa: 32 }, nature: "Modest", ability: "Adaptability" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ SpA Adaptability Dragalge Draco Meteor vs. 0 HP / 0 SpD Arcanine: 160-190 (96.9 - 115.1%) -- 81.3% chance to OHKO")
    ...
    it("Guts: boosts physical Attack by 1.5x when statused", () => {
      const attacker = new Pokemon("Flareon", { sps: { atk: 32 }, nature: "Adamant", ability: "Guts", status: "brn" })
      const defender = new Pokemon("Arcanine", {})
      ...
      expect(result.description()).toEqual("32+ Atk Guts Flareon Flare Blitz vs. 0 HP / 0 Def Arcanine: 102-120 (61.8 - 72.7%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(102)
      expect((result.damage as number[])[15]).toEqual(120)
    })

    it("Huge Power: doubles physical Attack", () => {
      const attacker = new Pokemon("Azumarill", { sps: { atk: 32 }, nature: "Adamant", ability: "Huge Power" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Huge Power Azumarill Play Rough vs. 0 HP / 0 Def Incineroar: 103-123 (60.5 - 72.3%) -- guaranteed 2HKO")
    ...
    it("Water Bubble: doubles Water-type attack", () => {
      const attacker = new Pokemon("Araquanid", { sps: { atk: 32 }, nature: "Adamant", ability: "Water Bubble" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Water Bubble Araquanid Liquidation vs. 0 HP / 0 Def Incineroar: 236-278 (138.8 - 163.5%) -- guaranteed OHKO")
    ...
    it("Solar Power: boosts Special Attack by 1.5x in Sun", () => {
      const attacker = new Pokemon("Charizard", { sps: { spa: 32 }, nature: "Modest", ability: "Solar Power" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles", weather: "Sun" })
      ...
      expect(result.description()).toEqual("32+ SpA Solar Power Charizard Flamethrower vs. 0 HP / 0 SpD Gardevoir in Sun: 150-177 (104.8 - 123.7%) -- guaranteed OHKO")
    ...
    it("Flash Fire (active): boosts Fire moves by 1.5x", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", ability: "Flash Fire", abilityOn: true })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ SpA Flash Fire Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir: 94-112 (65.7 - 78.3%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(94)
      expect((result.damage as number[])[15]).toEqual(112)
    })
    ...
    it("Parental Bond: adds child hit at 0.25x", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Parental Bond Kangaskhan-Mega Facade vs. 0 HP / 0 Def Arcanine: 94-113 (56.9 - 68.4%) -- guaranteed 2HKO")
    ...
    it("Sniper: boosts crit multiplier to 2.25x", () => {
      const attacker = new Pokemon("Beedrill", { sps: { atk: 32 }, nature: "Adamant", ability: "Sniper" })
      const defender = new Pokemon("Gardevoir", {})
      ...
      expect(result.description()).toEqual("32+ Atk Sniper Beedrill Cross Poison vs. 0 HP / 0 Def Gardevoir on a critical hit: 327-390 (228.6 - 272.7%) -- guaranteed OHKO")
    ...
    it("Overgrow: boosts Grass moves when HP<=1/3", () => {
      const attacker = new Pokemon("Venusaur", { sps: { spa: 32 }, nature: "Modest", ability: "Overgrow" })
      ...
      expect(result.description()).toEqual("32+ SpA Overgrow Venusaur Giga Drain vs. 0 HP / 0 SpD Incineroar: 48-57 (28.2 - 33.5%) -- 0.5% chance to 3HKO")
  ...
  describe("Defender abilities", () => {
    it("Thick Fat: halves Fire and Ice damage", () => {
      ...
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, spd: 10 }, nature: "Careful", ability: "Thick Fat" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Arcanine Flamethrower vs. 32 HP / 10+ SpD Thick Fat Snorlax: 28-34 (10.4 - 12.7%) -- possible 8HKO")
    ...
    it("Purifying Salt: halves Ghost damage", () => {
      ...
      expect(result.description()).toEqual("32 SpA Gardevoir Shadow Ball vs. 0 HP / 0 SpD Purifying Salt Garganacl: 25-30 (14.2 - 17.1%) -- possible 6HKO")
    ...
    it("Multiscale: halves damage at full HP", () => {
      const attacker = new Pokemon("Arcanine", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Dragonite", { ability: "Multiscale", sps: { hp: 32 } })
    ...
    it("Solid Rock / Filter: reduces super-effective moves to 0.75x", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Rhyperior", { sps: { hp: 32, def: 13 }, nature: "Impish", ability: "Solid Rock" })
      const move = new Move("Close Combat")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ Atk Incineroar Close Combat vs. 32 HP / 13+ Def Solid Rock Rhyperior: 69-82 (31 - 36.9%) -- 73% chance to 3HKO")
    ...
    it("Fur Coat: doubles physical Defense", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Fake Out vs. 0 HP / 0 Def Fur Coat Furfrou: 18-22 (12 - 14.6%) -- possible 7HKO")
    ...
    it("Marvel Scale: boosts Defense by 1.5x when statused", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Fake Out vs. 0 HP / 0 Def Marvel Scale Milotic: 19-23 (11.1 - 13.5%) -- guaranteed 6HKO after burn damage")
    ...
    it("Unaware: ignores attacker boosts", () => {
      const attacker = new Pokemon("Gardevoir", { sps: { spa: 32 }, nature: "Timid", boosts: { spa: 6 } })
      ...
      expect(result.description()).toEqual("32 SpA Gardevoir Moonblast vs. 0 HP / 0 SpD Unaware Clefable: 87-103 (51.1 - 60.5%) -- guaranteed 2HKO")
    ...
    it("Water Bubble (defender): halves Fire damage", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Arcanine Flamethrower vs. 0 HP / 0 SpD Water Bubble Araquanid: 28-34 (19.5 - 23.7%) -- possible 5HKO")
      expect((result.damage as number[])[0]).toEqual(28)
      expect((result.damage as number[])[15]).toEqual(34)
    })

    it("Dry Skin: amplifies Fire damage by 1.25x", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 21 }, nature: "Modest" })
      const defender = new Pokemon("Heliolisk", { sps: { hp: 13 }, ability: "Dry Skin" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("21+ SpA Arcanine Flamethrower vs. 13 HP / 0 SpD Dry Skin Heliolisk: 87-103 (58 - 68.6%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(87)
      expect((result.damage as number[])[15]).toEqual(103)
    })
    ...
    it("Friend Guard: reduces damage to ally by 0.75x", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Ampharos Thunderbolt vs. 0 HP / 0 SpD Incineroar with an ally's Friend Guard: 63-75 (37 - 44.1%) -- guaranteed 3HKO")
  ...
  describe("Immunity abilities (0 damage)", () => {
    it("Sap Sipper: immune to Grass moves", () => {
      const attacker = new Pokemon("Appletun", { sps: { spa: 32 }, nature: "Modest" })
    ...
    it("Water Absorb: immune to Water moves", () => {
      const attacker = new Pokemon("Araquanid", { sps: { atk: 32 }, nature: "Adamant" })
  ...
  describe("Items (attacker)", () => {
    it("Choice Band: 1.5x physical Attack", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 20 }, nature: "Adamant", item: "Choice Band" })
      const defender = new Pokemon("Arcanine", { sps: { hp: 32, def: 15 } })
      const move = new Move("Fake Out")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("20+ Atk Choice Band Incineroar Fake Out vs. 32 HP / 15 Def Arcanine: 34-41 (17.2 - 20.8%) -- possible 5HKO")
    ...
    it("Choice Specs: 1.5x Special Attack", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", item: "Choice Specs" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ SpA Choice Specs Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir: 94-112 (65.7 - 78.3%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(94)
      expect((result.damage as number[])[15]).toEqual(112)
    })

    it("Life Orb: 1.3x damage", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 25 }, nature: "Modest", item: "Life Orb" })
      const defender = new Pokemon("Gardevoir", { sps: { hp: 20, spd: 13 } })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("25+ SpA Life Orb Arcanine Flamethrower vs. 20 HP / 13 SpD Gardevoir: 71-86 (43.5 - 52.7%) -- 13.7% chance to 2HKO")
      expect((result.damage as number[])[0]).toEqual(71)
      expect((result.damage as number[])[15]).toEqual(86)
    })

    it("Expert Belt: 1.2x on super-effective hits", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", item: "Expert Belt" })
      ...
      expect(result.description()).toEqual("32+ SpA Expert Belt Arcanine Flamethrower vs. 0 HP / 0 SpD Avalugg: 310-367 (182.3 - 215.8%) -- guaranteed OHKO")
    ...
    it("Muscle Band: 1.1x physical moves", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant", item: "Muscle Band" })
      const defender = new Pokemon("Arcanine", {})
      const move = new Move("Fake Out")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ Atk Muscle Band Incineroar Fake Out vs. 0 HP / 0 Def Arcanine: 31-37 (18.7 - 22.4%) -- possible 5HKO")
    ...
    it("Wise Glasses: 1.1x special moves", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", item: "Wise Glasses" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ SpA Wise Glasses Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir: 69-82 (48.2 - 57.3%) -- 91% chance to 2HKO")
      expect((result.damage as number[])[0]).toEqual(69)
      expect((result.damage as number[])[15]).toEqual(82)
    })

    it("Type-boost item (Charcoal): 1.2x Fire moves", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", item: "Charcoal" })
      const defender = new Pokemon("Gardevoir", {})
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ SpA Charcoal Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir: 76-90 (53.1 - 62.9%) -- guaranteed 2HKO")
  ...
  describe("Field conditions", () => {
    it("Sun: boosts Fire moves by 1.5x", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 28 }, nature: "Modest" })
      const defender = new Pokemon("Gardevoir", { sps: { hp: 32, spd: 25 }, nature: "Calm" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles", weather: "Sun" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("28+ SpA Arcanine Flamethrower vs. 32 HP / 25+ SpD Gardevoir in Sun: 72-85 (41.1 - 48.5%) -- guaranteed 3HKO")
    ...
    it("Sun: weakens Water moves by 0.5x", () => {
      const attacker = new Pokemon("Politoed", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ SpA Politoed Surf vs. 0 HP / 0 SpD Incineroar in Sun: 50-62 (29.4 - 36.4%) -- 52.5% chance to 3HKO")
    ...
    it("Rain: boosts Water moves by 1.5x", () => {
      const attacker = new Pokemon("Politoed", { sps: { spa: 14 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, spd: 7 } })
      const move = new Move("Surf")
      const field = new Field({ gameType: "Doubles", weather: "Rain" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("14+ SpA Politoed Surf vs. 32 HP / 7 SpD Incineroar in Rain: 134-162 (66.3 - 80.1%) -- guaranteed 2HKO")
    ...
    it("Sand: boosts Rock SpDef by 1.5x", () => {
      const attacker = new Pokemon("Ampharos", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Tyranitar", { sps: { spd: 32 } })
      const move = new Move("Thunderbolt")
      const field = new Field({ gameType: "Doubles", weather: "Sand" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Ampharos Thunderbolt vs. 0 HP / 32 SpD Tyranitar in Sand: 42-49 (24 - 28%) -- 89.4% chance to 4HKO")
      expect((result.damage as number[])[0]).toEqual(42)
    ...
    it("Snow: boosts Ice physical Defense by 1.5x", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Avalugg", { sps: { def: 32 }, nature: "Bold" })
      const move = new Move("Earthquake")
      const field = new Field({ gameType: "Doubles", weather: "Snow" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ Atk Incineroar Earthquake vs. 0 HP / 32+ Def Avalugg in Snow: 13-16 (7.6 - 9.4%)")
    ...
    it("Electric Terrain: boosts Electric moves by 1.3x for grounded", () => {
      const attacker = new Pokemon("Manectric", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 25 } })
      const move = new Move("Thunderbolt")
      const field = new Field({ gameType: "Doubles", terrain: "Electric" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Manectric Thunderbolt vs. 25 HP / 0 SpD Incineroar in Electric Terrain: 103-123 (52.8 - 63%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(103)
      expect((result.damage as number[])[15]).toEqual(123)
    })
    ...
    it("Grassy Terrain: boosts Grass moves by 1.3x", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Appletun Giga Drain vs. 0 HP / 0 SpD Incineroar in Grassy Terrain: 42-50 (24.7 - 29.4%) -- 0.1% chance to 4HKO after Grassy Terrain recovery")
      expect((result.damage as number[])[0]).toEqual(42)
    ...
    it("Grassy Terrain: weakens Earthquake by 0.5x", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Earthquake vs. 0 HP / 0 Def Arcanine in Grassy Terrain: 52-62 (31.5 - 37.5%) -- 0.1% chance to 3HKO after Grassy Terrain recovery")
      expect((result.damage as number[])[0]).toEqual(52)
      expect((result.damage as number[])[15]).toEqual(62)
    })
    ...
    it("Reflect: halves physical damage in Doubles", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Fake Out vs. 0 HP / 0 Def Arcanine through Reflect: 19-23 (11.5 - 13.9%) -- possible 8HKO")
      expect((result.damage as number[])[0]).toEqual(19)
      expect((result.damage as number[])[15]).toEqual(23)
    })
    ...
    it("Light Screen: halves special damage in Doubles", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir through Light Screen: 42-50 (29.3 - 34.9%) -- 14% chance to 3HKO")
      expect((result.damage as number[])[0]).toEqual(42)
      expect((result.damage as number[])[15]).toEqual(50)
    })
    ...
    it("Aurora Veil: halves all damage in Doubles", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Fake Out vs. 0 HP / 0 Def Arcanine with an ally's Aurora Veil: 19-23 (11.5 - 13.9%) -- possible 8HKO")
      expect((result.damage as number[])[0]).toEqual(19)
      expect((result.damage as number[])[15]).toEqual(23)
    })
    ...
    it("Helping Hand: boosts ally's move by 1.5x", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Arcanine Helping Hand Flamethrower vs. 0 HP / 0 SpD Gardevoir: 94-112 (65.7 - 78.3%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(94)
      expect((result.damage as number[])[15]).toEqual(112)
    })
  })
  ...
  describe("Battery and Power Spot", () => {
    it("Battery: boosts special moves by 1.3x", () => {
      const attacker = new Pokemon("Miraidon", { sps: { hp: 6, def: 1, spa: 31, spd: 2, spe: 26 }, nature: "Modest", ability: "Hadron Engine", abilityOn: true, item: "Choice Specs" })
      const defender = new Pokemon("Koraidon", { sps: { hp: 30, atk: 25, def: 1, spd: 1, spe: 9 }, nature: "Adamant", ability: "Orichalcum Pulse", item: "Clear Amulet" })
      const move = new Move("Draco Meteor")
      const field = new Field({ gameType: "Doubles", terrain: "Electric", attackerSide: new Side({ isBattery: true }) })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("31+ SpA Choice Specs Hadron Engine Miraidon Battery boosted Draco Meteor vs. 30 HP / 1 SpD Koraidon: 642-756 (313.1 - 368.7%) -- guaranteed OHKO")
    ...
    it("Power Spot: boosts all moves by 1.3x", () => {
      ...
      expect(result.description()).toEqual("31+ SpA Choice Specs Hadron Engine Miraidon Power Spot boosted Draco Meteor vs. 30 HP / 1 SpD Koraidon: 642-756 (313.1 - 368.7%) -- guaranteed OHKO")
      expect((result.damage as number[])[0]).toEqual(642)
      expect((result.damage as number[])[15]).toEqual(756)
    })
  })
  ...
  describe("Critical hits", () => {
    it("Normal crit: 1.5x damage, ignores negative atk boosts and positive def boosts", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 32 }, nature: "Modest", boosts: { spa: -1 } })
      ...
      expect(result.description()).toEqual("32+ SpA Arcanine Flamethrower vs. 0 HP / 0 SpD Gardevoir on a critical hit: 94-112 (65.7 - 78.3%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(94)
      expect((result.damage as number[])[15]).toEqual(112)
    })
    ...
    it("Shell Armor: prevents critical hits", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Ampharos Thunderbolt vs. 0 HP / 0 SpD Slowbro-Mega: 186-222 (109.4 - 130.5%) -- guaranteed OHKO")
    ...
    it("Merciless: always crits vs poisoned", () => {
      const attacker = new Pokemon("Toxapex", { sps: { spa: 32 }, nature: "Modest", ability: "Merciless" })
  ...
  describe("Fixed damage moves", () => {
    ...
    it("Final Gambit: deals damage equal to attacker HP", () => {
      const attacker = new Pokemon("Staraptor", { sps: { hp: 32 } })
      const defender = new Pokemon("Incineroar", {})
  ...
  describe("Multi-hit moves", () => {
    it("Triple Axel: multi-hit with progressive BP", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Weavile Triple Axel (120 BP) (3 hits) vs. 0 HP / 0 Def Incineroar: 59-71 (34.7 - 41.7%) -- guaranteed 3HKO")
  ...
  describe("Special move categories", () => {
    it("Foul Play: uses defender's Attack stat", () => {
      const attacker = new Pokemon("Kingambit", { sps: { atk: 0 } })
      const defender = new Pokemon("Krookodile", { sps: { atk: 32, hp: 1 }, nature: "Adamant" })
      const move = new Move("Foul Play")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ Atk Kingambit Foul Play vs. 1 HP / 0 Def Krookodile: 50-59 (29.2 - 34.5%) -- 4.8% chance to 3HKO")
      expect((result.damage as number[])[0]).toEqual(50)
      expect((result.damage as number[])[15]).toEqual(59)
    })

    it("Body Press: uses attacker's Defense as attack stat", () => {
      const attacker = new Pokemon("Corviknight", { sps: { def: 25 }, nature: "Impish" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, def: 1 } })
      const move = new Move("Body Press")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("25+ Def Corviknight Body Press vs. 32 HP / 1 Def Incineroar: 90-108 (44.5 - 53.4%) -- 33.6% chance to 2HKO")
      expect((result.damage as number[])[0]).toEqual(90)
  ...
  describe("Tera type interactions", () => {
    it("Tera STAB: adds STAB bonus for Tera type", () => {
      ...
      expect(result.description()).toEqual("32 SpA Tera Fairy Gardevoir Moonblast vs. 0 HP / 0 SpD Incineroar: 116-138 (68.2 - 81.1%) -- guaranteed 2HKO")
    ...
    it("Tera type changes effectiveness: Tera Steel vs Fairy", () => {
      ...
      expect(result.description()).toEqual("32 SpA Gardevoir Moonblast vs. 0 HP / 0 SpD Tera Steel Snorlax: 36-43 (15.3 - 18.2%) -- possible 6HKO")
  ...
  describe("Composite interactions", () => {
    it("Helping Hand × Life Orb: both boosts stack", () => {
      const attacker = new Pokemon("Arcanine", { sps: { spa: 15 }, nature: "Modest", item: "Life Orb" })
      const defender = new Pokemon("Gardevoir", { sps: { hp: 32, spd: 7 } })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles", attackerSide: new Side({ isHelpingHand: true }) })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("15+ SpA Life Orb Arcanine Helping Hand Flamethrower vs. 32 HP / 7 SpD Gardevoir: 103-122 (58.8 - 69.7%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(103)
      expect((result.damage as number[])[15]).toEqual(122)
    })

    it("Wonder Room: swaps Def and SpDef for damage calc", () => {
      const attacker = new Pokemon("Corviknight", { sps: { def: 32 }, nature: "Impish" })
      const defender = new Pokemon("Arcanine", {})
      const move = new Move("Body Press")
      ...
      expect(result.description()).toEqual("32+ SpD (Def) Corviknight Body Press vs. 0 HP / 0 Def (SpD) Arcanine in Wonder Room: 52-62 (31.5 - 37.5%) -- 87.9% chance to 3HKO")
      expect((result.damage as number[])[0]).toEqual(52)
      expect((result.damage as number[])[15]).toEqual(62)
    })
  })
  ...
  describe("Multi calc (two attackers)", () => {
    it("combines two attackers vs one defender", () => {
      const firstAttacker = new Pokemon("Garchomp", { sps: { atk: 32 }, nature: "Adamant" })
      const secondAttacker = new Pokemon("Gardevoir", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, spd: 1 } })
      ...
      expect(result.description()).toEqual("32+ Atk Garchomp Earthquake AND 32+ SpA Gardevoir Moonblast vs. 32 HP / 0 Def / 1 SpD Incineroar: 246-294 (121.7 - 145.5%) -- guaranteed OHKO")
  ...
  describe("Real VGC Matchup", () => {
    it("Ogerpon-Wellspring Ivy Cudgel vs Miraidon", () => {
      const attacker = new Pokemon("Ogerpon-Wellspring", { sps: { hp: 30, atk: 10, def: 19, spd: 12, spe: 3 }, nature: "Adamant", ability: "Water Absorb", item: "Wellspring Mask" })
      const defender = new Pokemon("Miraidon", { sps: { hp: 1, spa: 32, spe: 32 }, nature: "Timid", ability: "Hadron Engine", item: "Choice Specs" })
      const move = new Move("Ivy Cudgel")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("10+ Atk Wellspring Mask Ogerpon-Wellspring Ivy Cudgel vs. 1 HP / 0 Def Miraidon: 46-55 (26.1 - 31.2%) -- guaranteed 4HKO")
      expect((result.damage as number[])[0]).toEqual(46)
      expect((result.damage as number[])[15]).toEqual(55)
    })
    ...
    it("Ogerpon-Wellspring Ivy Cudgel vs Koraidon", () => {
      const attacker = new Pokemon("Ogerpon-Wellspring", { sps: { hp: 30, atk: 10, def: 19, spd: 12, spe: 3 }, nature: "Adamant", ability: "Water Absorb", item: "Wellspring Mask" })
      const defender = new Pokemon("Koraidon", { sps: { hp: 5 } })
      const move = new Move("Ivy Cudgel")
      const field = new Field({ gameType: "Doubles", weather: "Sun" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("10+ Atk Wellspring Mask Ogerpon-Wellspring Ivy Cudgel vs. 5 HP / 0 Def Koraidon in Sun: 21-24 (11.6 - 13.3%) -- possible 8HKO")
    ...
    it("Slow Start halves the Attack of a physical move", () => {
      const attacker = new Pokemon("Regigigas", { sps: { atk: 32 }, nature: "Adamant", ability: "Slow Start", abilityOn: true })
      const defender = new Pokemon("Blissey", { sps: { hp: 32 }, nature: "Bold" })
    ...
    it("Battle Armor blocks a critical hit", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Falinks", { sps: { hp: 32 }, nature: "Bold", ability: "Battle Armor" })
      const move = new Move("Close Combat")
      move.isCrit = true
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Close Combat vs. 32 HP / 0+ Def Falinks: 63-75 (36.6 - 43.6%) -- guaranteed 3HKO")
      expect(result.damage).toEqual([63, 64, 65, 66, 66, 67, 68, 69, 69, 70, 71, 72, 72, 73, 74, 75])
    })

    it("Cloud Nine cancels the weather boost", () => {
      const attacker = new Pokemon("Blastoise", { sps: { spa: 32 }, nature: "Modest", ability: "Torrent" })
      const defender = new Pokemon("Altaria", { sps: { hp: 32 }, nature: "Bold", ability: "Cloud Nine" })
      const move = new Move("Surf")
    ...
    it("Tera Shell does not override a type immunity", () => {
      const attacker = new Pokemon("Gengar", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Terapagos-Terastal", { sps: { hp: 32 }, nature: "Bold", ability: "Tera Shell" })
      const move = new Move("Shadow Ball")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("Koraidon Collision Course vs Terapagos-Terastal keeps super-effective boost despite Tera Shell", () => {
      const attacker = new Pokemon("Koraidon", { sps: { hp: 5, atk: 28, spe: 32 }, nature: "Adamant", ability: "Orichalcum Pulse", item: "Clear Amulet", abilityOn: true })
      const defender = new Pokemon("Terapagos-Terastal", { sps: { hp: 32, def: 23, spa: 10 }, nature: "Modest", ability: "Tera Shell", item: "Leftovers", teraType: "Stellar" })
      const move = new Move("Collision Course")
      const field = new Field({ gameType: "Doubles", weather: "Sun" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("28+ Atk Orichalcum Pulse Koraidon Collision Course (133.3251953125 BP) vs. 32 HP / 23 Def Tera Shell Terapagos-Terastal: 66-78 (32.6 - 38.6%) -- guaranteed 2HKO after Leftovers recovery")
    ...
    it("Koraidon Tera Fire Flame Charge raises base power to 60 (Tera STAB floor)", () => {
      const attacker = new Pokemon("Koraidon", { sps: { hp: 5, atk: 28, spe: 32 }, nature: "Adamant", ability: "Orichalcum Pulse", item: "Clear Amulet", teraType: "Fire", abilityOn: true })
      const defender = new Pokemon("Urshifu-Rapid-Strike", { sps: { atk: 32, spd: 1, spe: 32 }, nature: "Jolly", ability: "Unseen Fist", item: "Choice Scarf" })
      const move = new Move("Flame Charge")
      const field = new Field({ gameType: "Doubles", weather: "Sun" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("28+ Atk Orichalcum Pulse Tera Fire Koraidon Flame Charge (60 BP) vs. 0 HP / 0 Def Urshifu-Rapid-Strike in Sun: 57-67 (32.5 - 38.2%) -- 97.9% chance to 3HKO")
  ...
  describe("Ruin abilities", () => {
    it("Beads of Ruin: lowers other Pokémon's Special Defense by 0.75x", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Beads of Ruin Ampharos Thunderbolt vs. 32 HP / 1 SpD Incineroar: 112-133 (55.4 - 65.8%) -- guaranteed 2HKO")
    ...
    it("Sword of Ruin: lowers other Pokémon's Defense by 0.75x", () => {
      const attacker = new Pokemon("Chien-Pao", { sps: { atk: 32 }, nature: "Jolly", ability: "Sword of Ruin" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, def: 1 } })
      ...
      expect(result.description()).toEqual("32 Atk Sword of Ruin Chien-Pao Icicle Crash vs. 32 HP / 1 Def Incineroar: 50-59 (24.7 - 29.2%) -- 99.9% chance to 4HKO")
      expect((result.damage as number[])[0]).toEqual(50)
      expect((result.damage as number[])[15]).toEqual(59)
    })
    ...
    it("Tablets of Ruin: lowers other Pokémon's Attack by 0.75x", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Incineroar Darkest Lariat vs. 0 HP / 0 Def Tablets of Ruin Arcanine: 67-79 (40.6 - 47.8%) -- guaranteed 3HKO")
    ...
    it("Vessel of Ruin: lowers other Pokémon's Special Attack by 0.75x", () => {
      ...
      expect(result.description()).toEqual("32+ SpA Ampharos Thunderbolt vs. 0 HP / 0 SpD Vessel of Ruin Gardevoir: 52-63 (36.3 - 44%) -- guaranteed 3HKO")
      expect((result.damage as number[])[0]).toEqual(52)
      expect((result.damage as number[])[15]).toEqual(63)
    })
  })
  ...
  describe("Defensive items", () => {
    it("Assault Vest: 1.5x Special Defense", () => {
      const attacker = new Pokemon("Ampharos", { sps: { spa: 32 }, nature: "Modest" })
      const defender = new Pokemon("Incineroar", { sps: { hp: 32, spd: 1 }, item: "Assault Vest" })
      const move = new Move("Thunderbolt")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ SpA Ampharos Thunderbolt vs. 32 HP / 1 SpD Assault Vest Incineroar: 57-67 (28.2 - 33.1%) -- guaranteed 4HKO")
      expect((result.damage as number[])[0]).toEqual(57)
      expect((result.damage as number[])[15]).toEqual(67)
    })
    ...
    it("Eviolite: 1.5x Defense for not-fully-evolved Pokémon", () => {
      const attacker = new Pokemon("Incineroar", { sps: { atk: 32 }, nature: "Adamant" })
      const defender = new Pokemon("Dusclops", { sps: { hp: 32, def: 1 }, item: "Eviolite" })
      const move = new Move("Darkest Lariat")
      const field = new Field({ gameType: "Doubles" })

      const result = calculate(attacker, defender, move, field)

      expect(result.description()).toEqual("32+ Atk Incineroar Darkest Lariat vs. 32 HP / 1 Def Eviolite Dusclops: 80-96 (54.4 - 65.3%) -- guaranteed 2HKO")
  ...
  describe("Knock Off", () => {
    it("Knock Off: 1.5x BP when target holds a removable item", () => {
      const attacker = new Pokemon("Weavile", { sps: { atk: 32 }, nature: "Jolly" })
      ...
      expect(result.description()).toEqual("32 Atk Weavile Knock Off (97.5 BP) vs. 0 HP / 0 Def Gardevoir: 111-132 (77.6 - 92.3%) -- guaranteed 2HKO")
    ...
    it("Knock Off: base BP when target holds no item", () => {
      ...
      expect(result.description()).toEqual("32 Atk Weavile Knock Off vs. 0 HP / 0 Def Gardevoir: 75-88 (52.4 - 61.5%) -- guaranteed 2HKO")
  ...
  describe("Type-damage abilities", () => {
    it("Tinted Lens: doubles not-very-effective damage", () => {
      const attacker = new Pokemon("Venusaur", { sps: { spa: 32 }, nature: "Modest", ability: "Tinted Lens" })
      ...
      expect(result.description()).toEqual("32+ SpA Tinted Lens Venusaur Giga Drain vs. 0 HP / 0 SpD Charizard: 32-40 (20.9 - 26.1%) -- 1.6% chance to 4HKO")
      expect((result.damage as number[])[0]).toEqual(32)
      expect((result.damage as number[])[15]).toEqual(40)
    })

    it("Rocky Payload: boosts Rock moves by 1.5x", () => {
      const attacker = new Pokemon("Garganacl", { sps: { atk: 32 }, nature: "Adamant", ability: "Rocky Payload" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Rocky Payload Garganacl Rock Slide vs. 0 HP / 0 Def Incineroar: 146-174 (85.8 - 102.3%) -- 12.5% chance to OHKO")
    ...
    it("Transistor: boosts Electric moves by 1.5x", () => {
      const attacker = new Pokemon("Regieleki", { sps: { spa: 32 }, nature: "Modest", ability: "Transistor" })
      const defender = new Pokemon("Incineroar", {})
      const move = new Move("Thunderbolt")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ SpA Transistor Regieleki Thunderbolt vs. 0 HP / 0 SpD Incineroar: 102-120 (60 - 70.5%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(102)
      expect((result.damage as number[])[15]).toEqual(120)
    })

    it("Supreme Overlord: boosts power per fallen ally", () => {
      const attacker = new Pokemon("Kingambit", { sps: { atk: 32 }, nature: "Adamant", ability: "Supreme Overlord", alliesFainted: 2 })
      const defender = new Pokemon("Gardevoir", {})
  ...
  describe("Quark Drive / Protosynthesis stat boost", () => {
    it("Protosynthesis: boosts highest stat (Special Attack) by 1.3x", () => {
      const attacker = new Pokemon("Flutter Mane", { sps: { spa: 32 }, nature: "Timid", ability: "Protosynthesis", abilityOn: true, boostedStat: "spa" })
      const defender = new Pokemon("Incineroar", {})
      const move = new Move("Moonblast")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32 SpA Protosynthesis Flutter Mane Moonblast vs. 0 HP / 0 SpD Incineroar: 118-141 (69.4 - 82.9%) -- guaranteed 2HKO")
  ...
  describe("Tera Blast", () => {
    it("Tera Blast: uses physical category and Tera type when Attack is higher", () => {
      const attacker = new Pokemon("Garchomp", { sps: { atk: 32 }, nature: "Adamant", teraType: "Ground" })
      const defender = new Pokemon("Incineroar", {})
      ...
      expect(result.description()).toEqual("32+ Atk Tera Ground Garchomp Tera Blast (80 BP) vs. 0 HP / 0 Def Incineroar: 224-264 (131.7 - 155.2%) -- guaranteed OHKO")
  ...
  describe("Type effectiveness overrides (items and abilities)", () => {
    ...
    it("Iron Ball: removes Levitate's Ground immunity", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Garchomp Earthquake vs. 0 HP / 0 Def Rotom-Wash: 134-158 (107.2 - 126.4%) -- guaranteed OHKO")
      expect((result.damage as number[])[0]).toEqual(134)
    ...
    it("Ring Target: removes Normal-vs-Ghost type immunity", () => {
      ...
      expect(result.description()).toEqual("32+ Atk Arcanine Extreme Speed vs. 0 HP / 0 Def Gengar: 68-80 (50.3 - 59.2%) -- guaranteed 2HKO")
    ...
    it("Scrappy: allows Fighting moves to hit Ghost-type defenders", () => {
      const attacker = new Pokemon("Machamp", { sps: { atk: 32 }, nature: "Adamant", ability: "Scrappy" })
      const defender = new Pokemon("Gengar", {})
      const move = new Move("Close Combat")
      const field = new Field({ gameType: "Doubles" })
      ...
      expect(result.description()).toEqual("32+ Atk Machamp Close Combat vs. 0 HP / 0 Def Gengar: 84-100 (62.2 - 74%) -- guaranteed 2HKO")
      expect((result.damage as number[])[0]).toEqual(84)
    ...
    it("Mind's Eye: allows Fighting moves to hit Ghost-type defenders, same as Scrappy", () => {
      const attacker = new Pokemon("Machamp", { sps: { atk: 32 }, nature: "Adamant", ability: "Mind's Eye" })
      const defender = new Pokemon("Gengar", {})
      const move = new Move("Close Combat")
      const field = new Field({ gameType: "Doubles" })
  ...
  describe("Mold Breaker suppresses breakable abilities", () => {
    it("ignores Levitate, exposing the defender to Ground moves", () => {
      const attacker = new Pokemon("Excadrill", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      ...
      expect(result.description()).toEqual("32+ Atk Mold Breaker Excadrill Earthquake vs. 0 HP / 0 Def Rotom-Wash: 138-164 (110.4 - 131.2%) -- guaranteed OHKO")
    ...
    it("ignores Fluffy, restoring full damage on a contact move", () => {
      const attacker = new Pokemon("Pangoro", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      const defender = new Pokemon("Houndstone", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Fluffy" })
    ...
    it("ignores Fluffy, removing the doubled damage on a Fire move", () => {
      const attacker = new Pokemon("Emboar-Mega", { sps: { spa: 32 }, nature: "Modest", ability: "Mold Breaker" })
      const defender = new Pokemon("Houndstone", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Fluffy" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Eelevate, exposing the defender to Ground moves", () => {
      ...
      const defender = new Pokemon("Eelektross-Mega", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Eelevate" })
      const move = new Move("Earthquake")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Ice Scales on a special move", () => {
      const attacker = new Pokemon("Pangoro", { sps: { spa: 32 }, nature: "Modest", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Ice Scales" })
    ...
    it("ignores Punk Rock on a sound move", () => {
      const attacker = new Pokemon("Pangoro", { sps: { spa: 32 }, nature: "Modest", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Punk Rock" })
    ...
    it("ignores Grass Pelt under Grassy Terrain", () => {
      const attacker = new Pokemon("Pangoro", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Grass Pelt" })
      const move = new Move("Crunch")
      const field = new Field({ gameType: "Doubles", terrain: "Grassy" })
    ...
    it("ignores Well-Baked Body, removing the Fire immunity", () => {
      const attacker = new Pokemon("Emboar-Mega", { sps: { spa: 32 }, nature: "Modest", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Well-Baked Body" })
      const move = new Move("Flamethrower")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Wonder Guard, removing the immunity to non super-effective moves", () => {
      const attacker = new Pokemon("Pangoro", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Wonder Guard" })
      const move = new Move("Crunch")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Tera Shell at full HP", () => {
      const attacker = new Pokemon("Pangoro", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      const defender = new Pokemon("Terapagos-Terastal", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Tera Shell" })
      const move = new Move("Crunch")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Dazzling, allowing a priority move to land", () => {
      const attacker = new Pokemon("Hawlucha", { sps: { atk: 32 }, nature: "Adamant", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Dazzling" })
      const move = new Move("Bullet Punch")
      const field = new Field({ gameType: "Doubles" })
    ...
    it("ignores Wind Rider, allowing a wind move to land", () => {
      const attacker = new Pokemon("Emboar-Mega", { sps: { spa: 32 }, nature: "Modest", ability: "Mold Breaker" })
      const defender = new Pokemon("Snorlax", { sps: { hp: 32, def: 32, spd: 32 }, ability: "Wind Rider" })
  ...
  describe("Thousand Arrows", () => {
    it("Hits a Levitate target", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Rotom-Wash", { sps: { hp: 32 }, nature: "Bold", ability: "Levitate" })
    ...
    it("Hits a pure Flying target neutrally", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Tornadus", { sps: { hp: 32 }, nature: "Bold", ability: "Prankster" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Ignores the secondary type weakness of a Flying target", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Talonflame", { sps: { hp: 32 }, nature: "Bold", ability: "Flame Body" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Ignores the secondary type resistance of a Flying target", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Skarmory", { sps: { hp: 32 }, nature: "Bold", ability: "Sturdy" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Hits a Ground Flying target neutrally", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Landorus-Therian", { sps: { hp: 32 }, nature: "Bold", ability: "Intimidate" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Hits an Air Balloon holder", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Blissey", { sps: { hp: 32 }, nature: "Bold", ability: "Natural Cure", item: "Air Balloon" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Stays neutral against a Flying target holding an Iron Ball", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Talonflame", { sps: { hp: 32 }, nature: "Bold", ability: "Flame Body", item: "Iron Ball" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
    ...
    it("Keeps the normal effectiveness against a grounded target", () => {
      const attacker = new Pokemon("Zygarde", { sps: { atk: 32 }, nature: "Adamant", ability: "Aura Break" })
      const defender = new Pokemon("Magnezone", { sps: { hp: 32 }, nature: "Bold", ability: "Sturdy" })
      const move = new Move("Thousand Arrows")
      const field = new Field({ gameType: "Singles" })
