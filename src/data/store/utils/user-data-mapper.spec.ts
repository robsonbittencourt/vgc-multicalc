...
describe("User Data Mapper", () => {
  describe("buildUserData", () => {
    it("should build user data for speedCalcPokemon", () => {
      ...
      const result = buildUserData(speedCalcPokemon, speedCalcPokemon, speedCalcPokemon, teams, targets, "MB", "high", "medium", "low", "high")
    ...
    it("should build user data for leftPokemon", () => {
      ...
      const result = buildUserData(leftPokemon, leftPokemon, leftPokemon, teams, targets, "MB", "high", "medium", "low", "high")
    ...
    it("should build user data for rightPokemon", () => {
      ...
      const result = buildUserData(rightPokemon, rightPokemon, rightPokemon, teams, targets, "MB", "high", "medium", "low", "high")
    ...
    it("should build user data for teams", () => {
      ...
      const result = buildUserData(teamPokemonOne, teamPokemonOne, teamPokemonOne, teams, targets, "MB", "high", "medium", "low", "high")
    ...
    it("should build user data for targets", () => {
      ...
      const result = buildUserData(targetOne, targetOne, targetOne, teams, targets, "MB", "high", "medium", "low", "high")
    ...
    it("should build user data for roll levels", () => {
      const result = buildUserData(pikachuState, pikachuState, pikachuState, [], [], "MB", "low", "medium", "high", "medium")
  ...
  describe("buildState", () => {
    ...
    it("should build roll levels in CalculatorState from user data", () => {
      const userData = {
        ...
        teams: [],
        targets: [],
        simpleCalcLeftRollLevel: "medium",
        simpleCalcRightRollLevel: "low",
