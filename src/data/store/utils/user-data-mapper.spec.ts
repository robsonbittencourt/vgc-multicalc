...
describe("User Data Mapper", () => {
  describe("buildUserData", () => {
    it("should build user data for speedCalcPokemon", () => {
      ...
      const result = buildUserData(speedCalcPokemon, speedCalcPokemon, speedCalcPokemon, teams, targets, "MA", "high", "medium", "low", "high")
    ...
    it("should build user data for leftPokemon", () => {
      ...
      const result = buildUserData(leftPokemon, leftPokemon, leftPokemon, teams, targets, "MA", "high", "medium", "low", "high")
    ...
    it("should build user data for rightPokemon", () => {
      ...
      const result = buildUserData(rightPokemon, rightPokemon, rightPokemon, teams, targets, "MA", "high", "medium", "low", "high")
    ...
    it("should build user data for teams", () => {
      ...
      const result = buildUserData(teamPokemonOne, teamPokemonOne, teamPokemonOne, teams, targets, "MA", "high", "medium", "low", "high")
    ...
    it("should build user data for targets", () => {
      ...
      const result = buildUserData(targetOne, targetOne, targetOne, teams, targets, "MA", "high", "medium", "low", "high")
    ...
    it("should build user data for roll levels", () => {
      const result = buildUserData(pikachuState, pikachuState, pikachuState, [], [], "MA", "low", "medium", "high", "medium")
